...
A tabela usada para testes deve conter os seguintes registros após importada: 

.. csv-table:: Registro de teste da tabela locutores
   :file: locutores.csv
   :header-rows: 1 

``Note que é necessário que as flags de schedule, bem como os horários de streaming estejam setadas 
corretamente para a autenticação ocorrer corretamente``
